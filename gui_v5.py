...
def show_tactical_popup():
    ...
    tactical_popup.title(f"Tactical View – Possession {pid}")
    ...
    notebook.add(france_tab, text="🇫🇷 France")
    notebook.add(usa_tab, text="🇺🇸 USA")
    notebook.add(combined_tab, text="⚔️ Combined View")
    ...
    def draw_team_tab(frame, team_name, color, player_dict):
        ...
        try:
            ...
            print(f"⚠️ Error while plotting possession: {e}")
...
def show_tactical_popup():
    ...
    def draw_combined_tab(frame, france_dict, usa_dict):
        ...
        # تقسيم الشاشة: الشمال (أزرار) / اليمين (الرسم)
        ...
        ax.set_title(
            "🇫🇷 France vs USA 🇺🇸 — Combined Tactical View",
        ...
        def update_visibility(mode):
            ...
            ax.set_title("🇫🇷 France vs USA 🇺🇸 — Combined Tactical View",
                        fontsize=15, color="#1E3A8A", weight="bold", pad=15)
            ...
            if show_ball:
                try:
                    ...
                    print(f"⚠️ Error plotting possession: {e}")
        ...
        tk.Button(left_frame, text="🇫🇷 France", bg=france_color, fg="white",
                font=("Arial", 11, "bold"), width=14, relief="flat",
                command=lambda: update_visibility("france")).pack(pady=5)

        tk.Button(left_frame, text="🇺🇸 USA", bg=usa_color, fg="white",
                font=("Arial", 11, "bold"), width=14, relief="flat",
                command=lambda: update_visibility("usa")).pack(pady=5)

        tk.Button(left_frame, text="⚽ Ball", bg="#1B5E20", fg="white",
                font=("Arial", 11, "bold"), width=14, relief="flat",
                command=lambda: update_visibility("possession")).pack(pady=5)

        tk.Button(left_frame, text="👁 Show All", bg="#0D47A1", fg="white",
                font=("Arial", 11, "bold"), width=14, relief="flat",
